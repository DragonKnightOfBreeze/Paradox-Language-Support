...
- [x] 优化：将模式为 `REPLACE_OR_CREATE` 的定义注入识别为定义声明 / OP: Optimize the detection of subtypes for definition injection (especially for modes `REPLACE`, `TRY_REPLACE`, or `REPLACE_OR_CREATE`) #273
