...
icu.windea.pls.core.index.hierarchy.ParadoxEventHierarchyIndex.Data.getEventToEventInfosMap
# 类似这样的地方也会对性能产生一定影响 
icu.windea.pls.core.index.ParadoxComplexEnumValueIndex.Data.getComplexEnumValueGroup - 17%
icu.windea.pls.core.index.hierarchy.ParadoxEventHierarchyIndex.Data.getEventToEventInfosMap 40%
```
