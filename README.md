...
- Some complex language constructs of script files and localisation files is not yet complete, and is still being improved.
...
- The quality of config-driven features (such as code completion, code inspection and quick documentation) depends on the completeness and up-to-dateness of the CWT config files for each game.
  ...
  Configs for other games may be outdated, which can result in false warnings or missing completions.
