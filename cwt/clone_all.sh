...
git clone git@github.com:/DragonKnightOfBreeze/cwtools-ir-config && echo "git clone cwtools-ir-config: DONE" 2>&1

# rm -rf cwtools-stellaris-config
git clone git@github.com:/DragonKnightOfBreeze/cwtools-stellaris-config && echo "git clone cwtools-stellaris-config: DONE" 2>&1
