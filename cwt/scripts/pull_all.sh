...
git pull origin master && git pull https://github.com/cwtools/cwtools-ck3-config master && echo "git pull cwtools-ck3-config: DONE" 2>&1

cd $root_path/cwtools-eu4-config
git pull origin master && git pull https://github.com/cwtools/cwtools-eu4-config master && echo "git pull cwtools-eu4-config: DONE" 2>&1

cd $root_path/cwtools-hoi4-config
git pull origin master && git pull https://github.com/cwtools/cwtools-hoi4-config master && echo "git pull cwtools-hoi4-config: DONE" 2>&1
...
git pull origin master && git pull https://github.com/cwtools/cwtools-vic3-config master && echo "git pull cwtools-vic3-config: DONE" 2>&1
