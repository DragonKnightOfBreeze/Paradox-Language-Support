...
- 参考文档 [附录：语法参考](ref-syntax.md) 中的 [对应章节](ref-syntax.md#cwt)
...
你可以在[远程的规则分组](##config-group-remote)、[本地的规则分组](##config-group-local)或是[项目本地的规则分组](##config-group-project-local)的对应的目录下编写自定义规则文件。  
