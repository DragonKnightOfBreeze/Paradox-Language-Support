...
class CwtConfigSelectDslTest : BasePlatformTestCase() {
    ...
    fun ofNames_basic() {
        ...
        val k3List = selectScope {
            k2.properties().ofNames(listOf("k3", "not_exists"), ignoreCase = true, usePattern = false).all()
        }
