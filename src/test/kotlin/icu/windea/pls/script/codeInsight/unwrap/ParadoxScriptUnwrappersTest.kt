...
class ParadoxScriptUnwrappersTest : UnwrapTestCase(), ChronicleTestScope {
    ...
    fun testInlineConditionalBlockRemover() {
        ...
        val option1 = ChronicleBundle.message("script.remove.inlineConditionalBlock", ChronicleStrings.(getConditionalBlockFolder())("A"))
        val option2 = ChronicleBundle.message("script.unwrap.inlineConditionalBlock", ChronicleStrings.(getConditionalBlockFolder())("A"))
    ...
    fun testConditionalBlockUnwrapper() {
        ...
        val after = """
            foo = bar
            """.trimIndent()
        val option1 = ChronicleBundle.message("script.remove.conditionalBlock", ChronicleStrings.(getConditionalBlockFolder())("P"))
        val option2 = ChronicleBundle.message("script.unwrap.conditionalBlock", ChronicleStrings.(getConditionalBlockFolder())("P"))
        assertOptions(before, option1, option2)
        assertUnwrapped(before, after, 1)
    }
