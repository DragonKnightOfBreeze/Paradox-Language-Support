...
class ParadoxLocalisationSyntaxPsiTest : BasePlatformTestCase() {
    ...
    fun testSampleBasic() {
        myFixture.configureByFile("localisation/t_sample.yml")
    ...
    fun testTextFormatsAndIcons() {
        myFixture.configureByFile("localisation/t_137_text_formats_and_text_icons.yml")
        val file = myFixture.file as ParadoxLocalisationFile
        Assert.assertNotNull(file.propertyList)
    }

    fun testGameTypeSupport_TextFormat_ck3_true() {
        myFixture.configureByFile("localisation/t_ck3_text_formats.yml")
        val file = myFixture.file as ParadoxLocalisationFile
    ...
    fun testGameTypeSupport_TextFormat_stellaris_false() {
        myFixture.configureByFile("localisation/t_stellaris_text_formats.yml")
        val file = myFixture.file as ParadoxLocalisationFile
    ...
    fun testGameTypeSupport_TextIcon_vic3_true() {
        myFixture.configureByFile("localisation/t_vic3_text_icons.yml")
        val file = myFixture.file as ParadoxLocalisationFile
