...
class ParadoxArrayDefineReferenceExpressionEvaluatorTest : BasePlatformTestCase(), ChronicleTestScope {
    ...
    fun simple() {
        ...
        val evaluator = ParadoxArrayDefineReferenceExpressionEvaluator()
