...
class ReplaceDefineReferenceWithEvaluationResultIntentionTest : BasePlatformTestCase(), ChronicleTestScope {
    ...
    fun smoke_test() {
        ...
        val intentionName = ChronicleIntentionBundle.message("intention.replaceDefineReferenceWithEvaluationResult")
