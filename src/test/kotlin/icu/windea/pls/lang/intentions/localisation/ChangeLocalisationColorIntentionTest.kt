...
class ChangeLocalisationColorIntentionTest : BasePlatformTestCase(), ChronicleTestScope {
    ...
    fun testAvailable_onColorToken() {
        configureColorFile()
        val intentionName = ChronicleIntentionBundle.message("intention.changeLocalisationColor")
