...
class IncorrectEventIdInspectionTest : BasePlatformTestCase(), ChronicleTestScope {
    ...
    fun stellaris_invalidNoDot() {
        val tag = ChronicleInspectionBundle.message("script.incorrectEventId.desc", "test").toWarningTag()
    ...
    fun stellaris_invalidEmptyPrefix() {
        val tag = ChronicleInspectionBundle.message("script.incorrectEventId.desc", ".1").toWarningTag()
    ...
    fun stellaris_invalidNonNumeric() {
        val tag = ChronicleInspectionBundle.message("script.incorrectEventId.desc", "test.abc").toWarningTag()
    ...
    fun stellaris_invalidHyphen() {
        val tag = ChronicleInspectionBundle.message("script.incorrectEventId.desc", "test-name.1").toWarningTag()
    ...
    fun stellaris_invalidMultipleDots() {
        val tag = ChronicleInspectionBundle.message("script.incorrectEventId.desc", "test.1.2").toWarningTag()
