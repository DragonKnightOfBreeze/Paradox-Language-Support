...
class MismatchedEventIdInspectionTest : BasePlatformTestCase(), ChronicleTestScope {
    ...
    fun stellaris_mismatchedSingle() {
        val eventId = "bar.1"
        val namespace = "foo"
        val tag = ChronicleInspectionBundle.message("script.mismatchedEventId.desc.2", eventId, namespace).toWarningTag()
    ...
    fun stellaris_noNamespace() {
        val eventId = "foo.1"
        val tag = ChronicleInspectionBundle.message("script.mismatchedEventId.desc.1", eventId).toWarningTag()
