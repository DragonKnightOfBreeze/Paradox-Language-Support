...
class ParadoxDefinitionReferenceInfoHintsProviderTest : DeclarativeInlayHintsProviderTestCase() {
    ...
    fun preview() {
        ...
        val text = "/inlayProviders/paradox.script.definitionReferenceInfo/preview.txt".toClasspathUrl().readText()
        doTest(text)
    }
