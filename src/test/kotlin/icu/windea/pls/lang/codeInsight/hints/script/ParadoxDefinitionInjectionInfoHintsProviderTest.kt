...
/**
 * @see ParadoxDefinitionInjectionInfoHintsProvider
 */
@RunWith(JUnit4::class)
@TestDataPath("\$CONTENT_ROOT/testData")
class ParadoxDefinitionInjectionInfoHintsProviderTest : DeclarativeInlayHintsProviderTestCase(), ChronicleTestScope {
    ...
    private fun doTest(text: String) {
        ...
        doTestProvider("test.txt", text, ParadoxDefinitionInjectionInfoHintsProvider(), verifyHintsPresence = true, testMode = ProviderTestMode.SIMPLE)
    }
}
