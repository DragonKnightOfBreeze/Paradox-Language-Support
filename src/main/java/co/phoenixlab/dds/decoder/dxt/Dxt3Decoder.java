...
public class Dxt3Decoder extends AbstractDxtDecoder {

    public Dxt3Decoder(Dds dds) {
        super(dds, BcHelper.BC2_DXT3_BLOCK_SIZE_BYTES);
    }
    ...
    public int[] decodeLine() {
        ...
        if (subRow == 0) {
            ...
            for (int i = 0; i < blockRowWidth; i++) {
                bc.decompressBc2Block(rawBlockLineCache, i * blockByteSize, decodedBlocks, i * 16);
            }
        }
