...
interface ParadoxLocalisationPsiCodeInjectors {
    ...
    class ForLocale : CodeInjectorBase()
    ...
    // @FieldCache("getText", cleanup = "subtreeChanged")
    class ForPropertyValue : CodeInjectorBase()
    ...
    @FieldCache("getText", cleanUp = "subtreeChanged")
    @FieldCache("getName", cleanUp = "subtreeChanged")
    class ForParameter : CodeInjectorBase()
    ...
    @FieldCache("getText", cleanUp = "subtreeChanged")
    @FieldCache("getName", cleanUp = "subtreeChanged")
    class ForIcon : CodeInjectorBase()
    ...
    @FieldCache("getText", cleanUp = "subtreeChanged")
    @FieldCache("getName", cleanUp = "subtreeChanged")
    class ForTextFormat : CodeInjectorBase()
    ...
    @FieldCache("getText", cleanUp = "subtreeChanged")
    @FieldCache("getName", cleanUp = "subtreeChanged")
    class ForTextIcon : CodeInjectorBase()
}
