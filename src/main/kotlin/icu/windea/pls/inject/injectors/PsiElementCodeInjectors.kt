...
@FieldCache(methods = ["getText", "getValue", "getName"], cleanupMethod = "subtreeChanged")
...
@FieldCache(methods = ["getText", "getValue"], cleanupMethod = "subtreeChanged")
...
@FieldCache(methods = ["getText", "getValue", "getColorType", "getColorArgs"], cleanupMethod = "subtreeChanged")
...
@FieldCache(methods = ["getText", "getName"], cleanupMethod = "subtreeChanged")
...
@FieldCache(methods = ["getText"], cleanupMethod = "subtreeChanged")
