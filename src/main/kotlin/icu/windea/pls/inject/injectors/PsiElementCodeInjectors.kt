...
@InjectFieldBasedCache(methods = ["getText", "getValue", "getName"], cleanupMethod = "subtreeChanged")
...
@InjectFieldBasedCache(methods = ["getText", "getValue"], cleanupMethod = "subtreeChanged")
...
@InjectFieldBasedCache(methods = ["getText", "getValue", "getColorType", "getColorArgs"], cleanupMethod = "subtreeChanged")
...
@InjectFieldBasedCache(methods = ["getText", "getName"], cleanupMethod = "subtreeChanged")
...
@InjectFieldBasedCache(methods = ["getText"], cleanupMethod = "subtreeChanged")
