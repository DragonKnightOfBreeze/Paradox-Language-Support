...
private val cacheForSingleton = CacheBuilder().build<String, ParadoxPath> { NormalizedParadoxPath(it, true) }
private val cache = CacheBuilder().build<String, ParadoxPath> { NormalizedParadoxPath(it, false) }
