...
private val cacheForSingleton = CacheBuilder().build<String, CwtConfigPath> { OptimizedCwtConfigPath(it, true) }
private val cache = CacheBuilder().build<String, CwtConfigPath> { OptimizedCwtConfigPath(it, false) }
