...
object ChronicleStrings {
    ...
    const val localisationConceptCommandFolderWithText = "['...', ...]"
    const val localisationTextIconFolder = "@...!"
    const val localisationTextFormatFolder = "#... ...#!"
    ...
    fun localisationConceptCommandFolderWithText(expression: String) = "['${expression}', ...]"
