...
class CwtPropertyWordSelectionHandler : ExtendWordSelectionHandlerBase() {
    ...
    private fun findElement(element: PsiElement): CwtProperty? {
        return element.parent?.castOrNull()
    }

    @Suppress("UNUSED_PARAMETER")
    private fun selectForProperty(element: CwtProperty, cursorOffset: Int, result: MutableList<TextRange>) {
        // add this
