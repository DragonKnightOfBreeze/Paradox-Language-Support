...
object CwtTokenSets {
    // used by the lexer
    // @JvmField val MERGED_TOKENS = TokenSet.create(TokenType.WHITE_SPACE, OPTION_KEY_TOKEN, PROPERTY_KEY_TOKEN, STRING_TOKEN) // some tokens are impossible
    @JvmField val MERGED_TOKENS = TokenSet.create(TokenType.WHITE_SPACE, STRING_TOKEN)

    // used by the parser definition
    @JvmField val WHITE_SPACES = TokenSet.create(TokenType.WHITE_SPACE, EOL)
    @JvmField val COMMENTS = TokenSet.create(COMMENT) // DO NOT add DOC_COMMENT or DOC_COMMENT_TOKEN here
    ...
    @JvmField val SEPARATORS = TokenSet.create(EQUAL_SIGN, NOT_EQUAL_SIGN, DOUBLE_EQUAL_SIGN)
    @JvmField val PROPERTY_SEPARATORS = TokenSet.create(EQUAL_SIGN, NOT_EQUAL_SIGN, DOUBLE_EQUAL_SIGN)
    @JvmField val BLOCK_BRACES = TokenSet.create(LEFT_BRACE, RIGHT_BRACE)
}
