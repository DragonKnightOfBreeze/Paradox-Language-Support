...
class CwtPropertyPointer(
    file: PsiFile,
    element: CwtProperty,
    propertyValue: CwtValue,
    private val delegate: SmartPsiElementPointer<CwtProperty> = element.createPointer(file)
) : SmartPsiElementPointer<CwtProperty> by delegate {
    val propertyValuePointer: SmartPsiElementPointer<CwtValue> = propertyValue.createPointer(file)
