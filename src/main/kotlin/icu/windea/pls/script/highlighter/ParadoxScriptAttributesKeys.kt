...
object ParadoxScriptAttributesKeys {
	...
	@JvmField val SCOPE_LINK_VALUE_KEY = createTextAttributesKey("PARADOX_SCRIPT.SCOPE_LINK_VALUE")
	@JvmField val VALUE_FIELD_KEY = createTextAttributesKey("PARADOX_SCRIPT.VALUE_LINK_VALUE", IDENTIFIER)
	@JvmField val VALUE_FIELD_PREFIX_KEY = createTextAttributesKey("PARADOX_SCRIPT.VALUE_FIELD_PREFIX", KEYWORD)
	@JvmField val VALUE_FIELD_VALUE_KEY = createTextAttributesKey("PARADOX_SCRIPT.VALUE_FIELD_VALUE")
    ...
    @JvmField val DATABASE_OBJECT_KEY = createTextAttributesKey("PARADOX_SCRIPT.DATABASE_OBJECT", DEFINITION_REFERENCE_KEY)
