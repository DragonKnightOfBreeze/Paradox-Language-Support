...
object ParadoxScriptAttributesKeys {
	private val _separatorName = message("script.externalName.separator")
	private val _bracesName = message("script.externalName.braces")
	private val _variableName = message("script.externalName.variable")
	private val _propertyKeyName = message("script.externalName.propertyKey")
	private val _keywordName = message("script.externalName.keyword")
	private val _colorName = message("script.externalName.color")
	private val _numberName = message("script.externalName.number")
	private val _stringName = message("script.externalName.string")
	private val _codeName = message("script.externalName.code")
	private val _commentName = message("script.externalName.comment")
	private val _validEscapeName = message("script.externalName.validEscape")
	private val _invalidEscapeName = message("script.externalName.invalidEscape")
	private val _badCharacterName = message("script.externalName.badCharacter")
	private val _definitionName = message("script.externalName.definition")
	private val _definitionReferenceName = message("script.externalName.definitionReference")
	private val _localisationReferenceName = message("script.externalName.localisationReference")
	private val _syncedLocalisationReferenceName = message("script.externalName.syncedLocalisationReference")
	private val _enumReferenceName = message("script.externalName.enumReference")
