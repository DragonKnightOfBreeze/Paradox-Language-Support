...
class ParadoxScriptSyntaxHighlighter : SyntaxHighlighterBase() {
	...
	override fun getTokenHighlights(tokenType: IElementType?) = when(tokenType) {
		...
		AT, SCRIPTED_VARIABLE_NAME_ID, SCRIPTED_VARIABLE_REFERENCE_ID, INLINE_MATH_SCRIPTED_VARIABLE_REFERENCE_ID -> VARIABLE_KEYS
		...
		INT_TOKEN, FLOAT_TOKEN, NUMBER_TOKEN, ARG_NUMBER_TOKEN -> NUMBER_KEYS
		STRING_TOKEN, QUOTED_STRING_TOKEN, VALUE_STRING_SNIPPET, ARG_STRING_TOKEN -> STRING_KEYS
