...
class ParadoxScriptSyntaxHighlighter(
    ...
    override fun getTokenHighlights(tokenType: IElementType?): Array<out TextAttributesKey> {
        return when(tokenType) {
            ...
            PIPE, KEY_PARAMETER_START, KEY_PARAMETER_END, VALUE_PARAMETER_START, VALUE_PARAMETER_END, INLINE_MATH_PARAMETER_START, INLINE_MATH_PARAMETER_END -> MARKER_KEYS
            ...
            AT, SCRIPTED_VARIABLE_NAME_TOKEN, SCRIPTED_VARIABLE_REFERENCE_TOKEN, INLINE_MATH_SCRIPTED_VARIABLE_REFERENCE_TOKEN -> SCRIPTED_VARIABLE_KEYS
            ARGUMENT_ID -> ARGUMENT_KEYS
            KEY_PARAMETER_TOKEN, VALUE_PARAMETER_TOKEN, INLINE_MATH_PARAMETER_TOKEN -> PARAMETER_KEYS
            PROPERTY_KEY_TOKEN, QUOTED_PROPERTY_KEY_TOKEN -> PROPERTY_KEY_KEYS
