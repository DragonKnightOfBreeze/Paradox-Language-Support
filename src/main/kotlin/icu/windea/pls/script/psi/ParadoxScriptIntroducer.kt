...
object ParadoxScriptIntroducer {
	 ...
	 */
	fun introduceLocalScriptedVariable(name: String, value: String, parentDefinition: ParadoxScriptProperty, project: Project): ParadoxScriptVariable {
	...
	private fun ParadoxScriptFile.findParentAndAnchorToIntroduceGlobalScriptedVariable(): Pair<PsiElement, PsiElement?>{
		val anchor = this.findChildOfType<ParadoxScriptVariable>(forward = false) ?: return this to this.lastChild
