...
object ParadoxScriptTokenSets {
    ...
    @JvmField val TEMPLATE_AWARE_TYPES = TokenSet.create(SCRIPTED_VARIABLE_NAME, PROPERTY_KEY, STRING, SCRIPTED_VARIABLE_REFERENCE)
    @JvmField val TEMPLATE_AWARE_LEFT_TYPES = TokenSet.create(SCRIPTED_VARIABLE_NAME, PROPERTY_KEY)
    @JvmField val TEMPLATE_AWARE_RIGHT_TYPES = TokenSet.create(STRING, SCRIPTED_VARIABLE_REFERENCE)
