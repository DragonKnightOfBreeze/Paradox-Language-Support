...
object ParadoxScriptTokenSets {
	...
	@JvmField val SCRIPTED_VARIABLE_REFERENCE_TOKENS = TokenSet.create(SCRIPTED_VARIABLE_REFERENCE_ID, INLINE_MATH_SCRIPTED_VARIABLE_REFERENCE_ID)
	...
	@JvmField val PARAMETER_OR_ARGUMENT_TOKENS = TokenSet.create(PARAMETER_ID, ARGUMENT_ID)
