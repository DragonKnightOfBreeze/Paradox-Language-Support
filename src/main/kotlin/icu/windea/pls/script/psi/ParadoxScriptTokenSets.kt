...
object ParadoxScriptTokenSets {
	...
	@JvmField val IDENTIFIERS = TokenSet.create(SCRIPTED_VARIABLE_NAME_ID, SCRIPTED_VARIABLE_REFERENCE_ID, PROPERTY_KEY_TOKEN, QUOTED_PROPERTY_KEY_TOKEN, STRING_TOKEN, QUOTED_STRING_TOKEN, INLINE_MATH_SCRIPTED_VARIABLE_REFERENCE_ID, ARGUMENT_ID, PARAMETER_ID)
	@JvmField val LITERALS = TokenSet.create(KEY_STRING_SNIPPET, VALUE_STRING_SNIPPET) 
	//@JvmField val LITERALS = TokenSet.create(PROPERTY_KEY_TOKEN, QUOTED_PROPERTY_KEY_TOKEN, STRING_TOKEN, QUOTED_STRING_TOKEN, KEY_STRING_SNIPPET, VALUE_STRING_SNIPPET, ARG_STRING_TOKEN) 
	...
	@JvmField val INLINE_MATH_PARAMETER_VALUES = TokenSet.create(INT_TOKEN, FLOAT_TOKEN, STRING_TOKEN)
