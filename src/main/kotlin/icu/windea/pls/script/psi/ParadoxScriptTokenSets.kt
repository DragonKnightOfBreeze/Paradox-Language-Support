...
object ParadoxScriptTokenSets {
    ...
    @JvmField
    val PROPERTY_SEPARATOR_TOKENS = TokenSet.create(EQUAL_SIGN, SAFE_EQUAL_SIGN, NOT_EQUAL_SIGN, LT_SIGN, GT_SIGN, LE_SIGN, GE_SIGN)
    @JvmField
    val COMPARISON_TOKENS = TokenSet.create(NOT_EQUAL_SIGN, LT_SIGN, GT_SIGN, LE_SIGN, GE_SIGN)
    @JvmField
