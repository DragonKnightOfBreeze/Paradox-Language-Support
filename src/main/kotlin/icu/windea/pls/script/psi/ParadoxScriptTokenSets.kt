...
object ParadoxScriptTokenSets {
    ...
    @JvmField val PARAMETER_VALUE_TOKENS = TokenSet.create(SNIPPET_TOKEN)
    ...
    @JvmField val TEMPLATE_TYPES = TokenSet.create(PROPERTY_KEY, STRING, SCRIPTED_VARIABLE_NAME, SCRIPTED_VARIABLE_REFERENCE, INLINE_MATH_SCRIPTED_VARIABLE_REFERENCE)
    @JvmField val SNIPPET_TYPES = TokenSet.create(PROPERTY_KEY_TOKEN, STRING_TOKEN, SCRIPTED_VARIABLE_NAME_TOKEN, SCRIPTED_VARIABLE_REFERENCE_TOKEN, INLINE_MATH_SCRIPTED_VARIABLE_REFERENCE_TOKEN)
    ...
    @JvmField val PROPERTY_SEPARATOR_TOKENS = TokenSet.create(EQUAL_SIGN, LT_SIGN, GT_SIGN, LE_SIGN, GE_SIGN, NOT_EQUAL_SIGN, QUESTION_EQUAL_SIGN)
