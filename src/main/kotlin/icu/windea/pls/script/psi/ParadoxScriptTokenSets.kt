...
object ParadoxScriptTokenSets {
    ...
    @JvmField val TEMPLATE_TYPES = TokenSet.create(SCRIPTED_VARIABLE_NAME, PROPERTY_KEY, STRING, SCRIPTED_VARIABLE_REFERENCE)
    @JvmField val TEMPLATE_LEFT_TYPES = TokenSet.create(SCRIPTED_VARIABLE_NAME, PROPERTY_KEY)
    @JvmField val TEMPLATE_RIGHT_TYPES = TokenSet.create(STRING, SCRIPTED_VARIABLE_REFERENCE)
