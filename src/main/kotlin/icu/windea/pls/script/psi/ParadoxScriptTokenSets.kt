...
object ParadoxScriptTokenSets {
	...
	@JvmField val IDENTIFIER_TOKENS = TokenSet.create(SCRIPTED_VARIABLE_NAME_TOKEN, SCRIPTED_VARIABLE_REFERENCE_TOKEN, PROPERTY_KEY_TOKEN, QUOTED_PROPERTY_KEY_TOKEN, STRING_TOKEN, QUOTED_STRING_TOKEN, INLINE_MATH_SCRIPTED_VARIABLE_REFERENCE_TOKEN, ARGUMENT_TOKEN, PARAMETER_TOKEN)
	...
	@JvmField val PARAMETER_OR_ARGUMENT_TOKENS = TokenSet.create(PARAMETER_TOKEN, ARGUMENT_TOKEN)
