...
object ParadoxScriptTokenSets {
	...
	@JvmField val IDENTIFIER_TOKENS = TokenSet.create(SCRIPTED_VARIABLE_NAME_TOKEN, SCRIPTED_VARIABLE_REFERENCE_TOKEN, PROPERTY_KEY_TOKEN, QUOTED_PROPERTY_KEY_TOKEN, STRING_TOKEN, QUOTED_STRING_TOKEN, INLINE_MATH_SCRIPTED_VARIABLE_REFERENCE_TOKEN, ARGUMENT_ID, KEY_PARAMETER_TOKEN, VALUE_PARAMETER_TOKEN, INLINE_MATH_PARAMETER_TOKEN)
	@JvmField val COMMENT_TOKENS = TokenSet.create(COMMENT)
	@JvmField val LITERAL_TOKENS = TokenSet.create(QUOTED_PROPERTY_KEY_TOKEN, QUOTED_STRING_TOKEN)
	...
	@JvmField val PARAMETER_OR_ARGUMENT_TOKENS = TokenSet.create(KEY_PARAMETER_TOKEN, VALUE_PARAMETER_TOKEN, INLINE_MATH_PARAMETER_TOKEN, ARGUMENT_ID)
	@JvmField val PARAMETERS = TokenSet.create(KEY_PARAMETER, VALUE_PARAMETER, INLINE_MATH_PARAMETER)
