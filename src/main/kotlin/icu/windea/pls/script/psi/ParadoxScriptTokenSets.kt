...
object ParadoxScriptTokenSets {
    ...
    @JvmField val TEMPLATE_TYPES = TokenSet.create(SCRIPTED_VARIABLE_NAME, SCRIPTED_VARIABLE_REFERENCE, PROPERTY_KEY, STRING)
    @JvmField val TEMPLATE_PARTS = TokenSet.create(SCRIPTED_VARIABLE_NAME_TOKEN, SCRIPTED_VARIABLE_REFERENCE_TOKEN, PROPERTY_KEY_TOKEN, STRING_TOKEN)
