...
object ParadoxScriptAttributesKeys {
    ...
    @JvmField val AT_SIGN_KEY = createTextAttributesKey("PARADOX_SCRIPT.AT_SIGN", STATIC_FIELD)
    @JvmField val SCRIPTED_VARIABLE_NAME_KEY = createTextAttributesKey("PARADOX_SCRIPT.SCRIPTED_VARIABLE_NAME", STATIC_FIELD)
    @JvmField val SCRIPTED_VARIABLE_REFERENCE_KEY = createTextAttributesKey("PARADOX_SCRIPT.SCRIPTED_VARIABLE_REFERENCE", STATIC_FIELD)
    @JvmField val PARAMETER_KEY = createTextAttributesKey("PARADOX_SCRIPT.PARAMETER", KEYWORD)
    @JvmField val CONDITION_PARAMETER_KEY = createTextAttributesKey("PARADOX_SCRIPT.CONDITION_PARAMETER", KEYWORD)  // KOTLIN_NAMED_ARGUMENT
    @JvmField val ARGUMENT_KEY = createTextAttributesKey("PARADOX_SCRIPT.ARGUMENT", KEYWORD) // KOTLIN_NAMED_ARGUMENT
    ...
    @JvmField val COLOR_KEY = createTextAttributesKey("PARADOX_SCRIPT.COLOR", KEYWORD) // HTML_TAG_NAME
    ...
    @JvmField val LOCALISATION_REFERENCE_KEY = createTextAttributesKey("PARADOX_SCRIPT.LOCALISATION_REFERENCE", LKeys.PROPERTY_KEY_KEY)
    @JvmField val SYNCED_LOCALISATION_REFERENCE_KEY = createTextAttributesKey("PARADOX_SCRIPT.SYNCED_LOCALISATION_REFERENCE", LOCALISATION_REFERENCE_KEY)
    @JvmField val DEFINE_NAMESPACE_KEY = createTextAttributesKey("PARADOX_SCRIPT.DEFINE_NAMESPACE", INSTANCE_METHOD)
    @JvmField val DEFINE_VARIABLE_KEY = createTextAttributesKey("PARADOX_SCRIPT.DEFINE_VARIABLE", GLOBAL_VARIABLE)
    ...
    @JvmField val DYNAMIC_VALUE_KEY = createTextAttributesKey("PARADOX_SCRIPT.DYNAMIC_VALUE", GLOBAL_VARIABLE)
    @JvmField val VARIABLE_KEY = createTextAttributesKey("PARADOX_SCRIPT.VARIABLE", GLOBAL_VARIABLE) // italic
    @JvmField val MODIFIER_KEY = createTextAttributesKey("PARADOX_SCRIPT.MODIFIER", CUSTOM_KEYWORD2_ATTRIBUTES)
    @JvmField val TRIGGER_KEY = createTextAttributesKey("PARADOX_SCRIPT.TRIGGER", CUSTOM_KEYWORD3_ATTRIBUTES)
    @JvmField val EFFECT_KEY = createTextAttributesKey("PARADOX_SCRIPT.EFFECT", CUSTOM_KEYWORD4_ATTRIBUTES)
    ...
    @JvmField val VALUE_FIELD_KEY = createTextAttributesKey("PARADOX_SCRIPT.VALUE_FIELD", IDENTIFIER) // HTML_ENTITY_REFERENCE
    @JvmField val DATABASE_OBJECT_TYPE_KEY = createTextAttributesKey("PARADOX_SCRIPT.DATABASE_OBJECT_TYPE", KEYWORD)
    @JvmField val DATABASE_OBJECT_KEY = createTextAttributesKey("PARADOX_SCRIPT.DATABASE_OBJECT")
    ...
    @JvmField val DEFINE_PREFIX_KEY = createTextAttributesKey("PARADOX_SCRIPT.DEFINE_PREFIX", KEYWORD)

    @JvmField val TAG_KEY = createTextAttributesKey("PARADOX_SCRIPT.TAG", METADATA)
    @JvmField val DIRECTIVE_KEY = createTextAttributesKey("PARADOX_SCRIPT.DIRECTIVE", KEYWORD) // JSP directive name
