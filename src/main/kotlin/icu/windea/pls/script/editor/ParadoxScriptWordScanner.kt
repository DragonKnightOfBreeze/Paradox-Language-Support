...
class ParadoxScriptWordScanner : DefaultWordsScanner(
	...
	TokenSet.create(VARIABLE_NAME_ID, VARIABLE_REFERENCE_ID, PROPERTY_KEY_TOKEN, QUOTED_PROPERTY_KEY_TOKEN, STRING_TOKEN, QUOTED_STRING_TOKEN, INLINE_MATH_VARIABLE_REFERENCE_ID, INPUT_PARAMETER_ID, PARAMETER_ID),
