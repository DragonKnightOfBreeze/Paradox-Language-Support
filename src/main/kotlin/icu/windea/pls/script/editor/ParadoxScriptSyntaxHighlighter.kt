...
class ParadoxScriptSyntaxHighlighter(
    ...
    override fun getTokenHighlights(tokenType: IElementType?): Array<out TextAttributesKey> {
        return when (tokenType) {
            ...
            EQUAL_SIGN, SAFE_EQUAL_SIGN, NOT_EQUAL_SIGN, LE_SIGN, LT_SIGN, GE_SIGN, GT_SIGN -> KA.OPERATOR_KEYS
            ...
            AT -> KA.AT_SIGN_KEYS
            SCRIPTED_VARIABLE_NAME_TOKEN -> KA.SCRIPTED_VARIABLE_NAME_KEYS
            SCRIPTED_VARIABLE_REFERENCE_TOKEN -> KA.SCRIPTED_VARIABLE_REFERENCE_KEYS
