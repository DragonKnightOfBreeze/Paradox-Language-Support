...
class ParadoxScriptSyntaxHighlighter(
    ...
    override fun getTokenHighlights(tokenType: IElementType?): Array<out TextAttributesKey> {
        return when (tokenType) {
            ...
            NOT_SIGN -> ColorSets.OPERATOR
            PIPE, PARAMETER_START, PARAMETER_END -> ColorSets.MARKER
            LEFT_BRACKET, RIGHT_BRACKET -> ColorSets.CONDITIONAL_BLOCK_BRACKETS
            NESTED_LEFT_BRACKET, NESTED_RIGHT_BRACKET -> ColorSets.CONDITIONAL_EXPRESSION_BRACKETS
