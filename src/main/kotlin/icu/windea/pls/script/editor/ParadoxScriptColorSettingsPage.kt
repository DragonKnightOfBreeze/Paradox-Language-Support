...
class ParadoxScriptColorSettingsPage : ColorSettingsPage {
	companion object {
		private val attributesDescriptors = arrayOf(
			...
			AttributesDescriptor(PlsBundle.message("script.displayName.complexEnumValueReference"), ParadoxScriptAttributesKeys.COMPLEX_ENUM_VALUE_REFERENCE_KEY),
	...
	private val tagToDescriptorMap = mapOf(
		...
		"ENUM_VALUE_REFERENCE" to ParadoxScriptAttributesKeys.ENUM_VALUE_REFERENCE_KEY,
		"COMPLEX_ENUM_VALUE_REFERENCE" to ParadoxScriptAttributesKeys.COMPLEX_ENUM_VALUE_REFERENCE_KEY,
