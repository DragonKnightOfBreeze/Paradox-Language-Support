...
class ParadoxScriptColorSettingsPage : ColorSettingsPage {
    private val _attributesDescriptors = arrayOf(
        ...
        AttributesDescriptor(PlsBundle.message("semantic.displayName.operator"), ParadoxScriptAttributesKeys.SEMANTIC_OPERATOR),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.marker"), ParadoxScriptAttributesKeys.SEMANTIC_MARKER),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.keyword"), ParadoxScriptAttributesKeys.SEMANTIC_KEYWORD),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.argument"), ParadoxScriptAttributesKeys.SEMANTIC_ARGUMENT),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.string"), ParadoxScriptAttributesKeys.SEMANTIC_STRING),

        AttributesDescriptor(PlsBundle.message("semantic.displayName.definition"), ParadoxScriptAttributesKeys.DEFINITION),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.definitionName"), ParadoxScriptAttributesKeys.DEFINITION_NAME),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.definitionReference"), ParadoxScriptAttributesKeys.DEFINITION_REFERENCE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.localisationReference"), ParadoxScriptAttributesKeys.LOCALISATION_REFERENCE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.syncedLocalisationReference"), ParadoxScriptAttributesKeys.SYNCED_LOCALISATION_REFERENCE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.defineNamespace"), ParadoxScriptAttributesKeys.DEFINE_NAMESPACE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.defineVariable"), ParadoxScriptAttributesKeys.DEFINE_VARIABLE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.enumValue"), ParadoxScriptAttributesKeys.ENUM_VALUE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.complexEnumValue"), ParadoxScriptAttributesKeys.COMPLEX_ENUM_VALUE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.dynamicValue"), ParadoxScriptAttributesKeys.DYNAMIC_VALUE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.variable"), ParadoxScriptAttributesKeys.VARIABLE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.modifier"), ParadoxScriptAttributesKeys.MODIFIER),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.trigger"), ParadoxScriptAttributesKeys.TRIGGER),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.effect"), ParadoxScriptAttributesKeys.EFFECT),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.systemScope"), ParadoxScriptAttributesKeys.SYSTEM_SCOPE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.scope"), ParadoxScriptAttributesKeys.SCOPE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.scopePrefix"), ParadoxScriptAttributesKeys.SCOPE_PREFIX),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.valueField"), ParadoxScriptAttributesKeys.VALUE_FIELD),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.valueFieldPrefix"), ParadoxScriptAttributesKeys.VALUE_FIELD_PREFIX),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.systemCommandScope"), ParadoxScriptAttributesKeys.SYSTEM_COMMAND_SCOPE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.commandScope"), ParadoxScriptAttributesKeys.COMMAND_SCOPE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.commandScopePrefix"), ParadoxScriptAttributesKeys.COMMAND_SCOPE_PREFIX),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.commandField"), ParadoxScriptAttributesKeys.COMMAND_FIELD),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.commandFieldPrefix"), ParadoxScriptAttributesKeys.COMMAND_FIELD_PREFIX),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.databaseObjectType"), ParadoxScriptAttributesKeys.DATABASE_OBJECT_TYPE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.databaseObject"), ParadoxScriptAttributesKeys.DATABASE_OBJECT),

        AttributesDescriptor(PlsBundle.message("semantic.displayName.tag"), ParadoxScriptAttributesKeys.TAG),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.macro"), ParadoxScriptAttributesKeys.MACRO),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.pathReference"), ParadoxScriptAttributesKeys.PATH_REFERENCE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.shaderEffectReference"), ParadoxScriptAttributesKeys.SHADER_EFFECT_REFERENCE),
        AttributesDescriptor(PlsBundle.message("semantic.displayName.meshLocatorReference"), ParadoxScriptAttributesKeys.MESH_LOCATOR_REFERENCE),
    )
    ...
    private val _tagToDescriptorMap = mapOf(
        ...
        "ARGUMENT" to ParadoxScriptAttributesKeys.SEMANTIC_ARGUMENT,
        ...
        "SHADER_EFFECT_REFERENCE" to ParadoxScriptAttributesKeys.SHADER_EFFECT_REFERENCE,
        "MESH_LOCATOR_REFERENCE" to ParadoxScriptAttributesKeys.MESH_LOCATOR_REFERENCE,
    )
