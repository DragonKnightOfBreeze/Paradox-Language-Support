...
class ParadoxScriptColorSettingsPage : ColorSettingsPage {
    private val _attributesDescriptors = arrayOf(
        ...
        AttributesDescriptor(PlsBundle.message("script.displayName.atSign"), ParadoxScriptAttributesKeys.AT_SIGN_KEY),
        AttributesDescriptor(PlsBundle.message("script.displayName.scriptedVariableName"), ParadoxScriptAttributesKeys.SCRIPTED_VARIABLE_NAME_KEY),
        AttributesDescriptor(PlsBundle.message("script.displayName.scriptedVariableReference"), ParadoxScriptAttributesKeys.SCRIPTED_VARIABLE_REFERENCE_KEY),
    ...
    private val _tagToDescriptorMap = mapOf(
        ...
        "DEFINE_NAMESPACE" to ParadoxScriptAttributesKeys.DEFINE_NAMESPACE_KEY,
        "DEFINE_VARIABLE" to ParadoxScriptAttributesKeys.DEFINE_VARIABLE_KEY,
        ...
        "VALUE_FIELD" to ParadoxScriptAttributesKeys.VALUE_FIELD_KEY,
        ...
        "DEFINE_PREFIX" to ParadoxScriptAttributesKeys.DEFINE_PREFIX_KEY,
