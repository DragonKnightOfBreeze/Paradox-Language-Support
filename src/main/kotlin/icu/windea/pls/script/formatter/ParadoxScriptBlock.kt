...
class ParadoxScriptBlock(
	...
	companion object {
		private val MEMBERS = TokenSet.create(SCRIPTED_VARIABLE, PROPERTY, BOOLEAN, INT, FLOAT, STRING, COLOR, INLINE_MATH, KEY_PARAMETER, VALUE_PARAMETER, BLOCK, PARAMETER_CONDITION)
		...
		private val SHOULD_INDENT_TYPES = TokenSet.create(SCRIPTED_VARIABLE, PROPERTY, BOOLEAN, INT, FLOAT, STRING, COLOR, INLINE_MATH, KEY_PARAMETER, VALUE_PARAMETER, BLOCK, PARAMETER_CONDITION, COMMENT)
		...
		private fun createSpacingBuilder(settings: CodeStyleSettings): SpacingBuilder {
			...
			return SpacingBuilder(settings, ParadoxScriptLanguage)
				.between(MEMBERS, MEMBERS).spaces(1, true) //封装变量/属性/值/参数条件块之间需要有空格或者换行
