...
import icu.windea.pls.script.psi.ParadoxScriptElementTypes.PARAMETER
import icu.windea.pls.script.psi.ParadoxScriptElementTypes.PARAMETER_CONDITION
import icu.windea.pls.script.psi.ParadoxScriptElementTypes.PARAMETER_CONDITION_EXPRESSION
...
class ParadoxScriptBlock(
    ...
    companion object {
        ...
        private val SEPARATORS = TokenSet.create(EQUAL_SIGN, NOT_EQUAL_SIGN, LT_SIGN, GT_SIGN, LE_SIGN, GE_SIGN, SAFE_EQUAL_SIGN)
