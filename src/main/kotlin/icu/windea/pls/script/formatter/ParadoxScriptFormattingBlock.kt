...
class ParadoxScriptFormattingBlock(
    ...
    companion object {
        private val MEMBERS = TokenSet.create(SCRIPTED_VARIABLE, PROPERTY, BOOLEAN, INT, FLOAT, STRING, COLOR, INLINE_MATH, BLOCK, NORMAL_CONDITIONAL_BLOCK)
        ...
        private val SHOULD_INDENT_TYPES = TokenSet.create(SCRIPTED_VARIABLE, PROPERTY, BOOLEAN, INT, FLOAT, STRING, COLOR, INLINE_MATH, BLOCK, NORMAL_CONDITIONAL_BLOCK, COMMENT)
