...
class ParadoxLocalisationIconPsiReference(
	...
	override fun resolve(): PsiElement? {
		//尝试解析为spriteType
		val spriteName = "GFX_text_${element.name}"
		...
		val ddsFiles = FilenameIndex.getFilesByName(project, "$spriteName.dds", GlobalSearchScope.allScope(project))
	...
	override fun getVariants(): Array<out Any> {
		...
		val ddsFiles = FilenameIndex.getAllFilesByExt(project, "dds")
