...
object ParadoxLocalisationAttributesKeySets {
    ...
    @JvmField val ICON = arrayOf(K.ICON)
    @JvmField val COMMAND = arrayOf(K.COMMAND)
    @JvmField val CONCEPT = arrayOf(K.CONCEPT)
    @JvmField val TEXT_ICON = arrayOf(K.TEXT_ICON)
    @JvmField val TEXT_FORMAT = arrayOf(K.TEXT_FORMAT)
    @JvmField val TEXT = arrayOf(K.TEXT)
