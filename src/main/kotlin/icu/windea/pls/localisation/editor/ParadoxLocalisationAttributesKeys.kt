...
object ParadoxLocalisationAttributesKeys {
    ...
    @JvmField
    val PROPERTY_REFERENCE_KEY = createTextAttributesKey("PARADOX_LOCALISATION.PROPERTY_REFERENCE", KEYWORD)
    @JvmField
    val PROPERTY_REFERENCE_PARAMETER_KEY = createTextAttributesKey("PARADOX_LOCALISATION.PROPERTY_REFERENCE_PARAMETER", KEYWORD)
    @JvmField
    ...
    @JvmField
    val CONCEPT_KEY = createTextAttributesKey("PARADOX_LOCALISATION.CONCEPT", IDENTIFIER)
    @JvmField
    ...
    @JvmField
    val DYNAMIC_VALUE_KEY = createTextAttributesKey("PARADOX_LOCALISATION.DYNAMIC_VALUE", LOCAL_VARIABLE)
    @JvmField
    val VARIABLE_KEY = createTextAttributesKey("PARADOX_LOCALISATION.VARIABLE", LOCAL_VARIABLE) //italic
    @JvmField
