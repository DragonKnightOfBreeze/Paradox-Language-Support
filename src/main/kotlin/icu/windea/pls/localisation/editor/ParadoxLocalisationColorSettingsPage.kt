...
class ParadoxLocalisationColorSettingsPage : ColorSettingsPage {
    private val _attributesDescriptors = arrayOf(
        ...
        AttributesDescriptor(PlsBundle.message("localisation.displayName.linkPrefix"), ParadoxLocalisationAttributesKeys.LINK_PREFIX_KEY),
    ...
    private val _tagToDescriptorMap = mapOf(
        ...
        "LINK_PREFIX" to ParadoxLocalisationAttributesKeys.LINK_PREFIX_KEY,
