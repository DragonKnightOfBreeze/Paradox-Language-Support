...
class ParadoxLocalisationColorSettingsPage : ColorSettingsPage {
    private val _attributesDescriptors = arrayOf(
        ...
        AttributesDescriptor(PlsBundle.message("localisation.displayName.commandSystemScope"), ParadoxLocalisationAttributesKeys.COMMAND_SYSTEM_SCOPE_KEY),
        ...
        AttributesDescriptor(PlsBundle.message("localisation.displayName.commandLinkPrefix"), ParadoxLocalisationAttributesKeys.COMMAND_LINK_PREFIX_KEY),
        AttributesDescriptor(PlsBundle.message("localisation.displayName.commandLinkValue"), ParadoxLocalisationAttributesKeys.COMMAND_LINK_VALUE_KEY),
    ...
    private val _tagToDescriptorMap = mapOf(
        ...
        "COMMAND_SYSTEM_SCOPE" to ParadoxLocalisationAttributesKeys.COMMAND_SYSTEM_SCOPE_KEY,
        ...
        "COMMAND_LINK_PREFIX" to ParadoxLocalisationAttributesKeys.COMMAND_LINK_PREFIX_KEY,
        "COMMAND_LINK_VALUE" to ParadoxLocalisationAttributesKeys.COMMAND_LINK_VALUE_KEY,
