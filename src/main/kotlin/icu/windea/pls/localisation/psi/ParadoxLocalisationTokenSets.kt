...
object ParadoxLocalisationTokenSets {
    ...
    @JvmField val IDENTIFIER_TOKENS = TokenSet.create(PROPERTY_KEY_TOKEN, PROPERTY_REFERENCE_TOKEN, SCRIPTED_VARIABLE_REFERENCE_TOKEN, ICON_TOKEN, COMMAND_TEXT_TOKEN, CONCEPT_NAME_TOKEN)
