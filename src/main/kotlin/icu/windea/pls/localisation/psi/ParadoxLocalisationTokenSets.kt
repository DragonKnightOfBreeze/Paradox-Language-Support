...
object ParadoxLocalisationTokenSets {
    ...
    @JvmField
    val PROPERTY_CONTAINER = TokenSet.create(PROPERTY_LIST, PROPERTY)
    @JvmField
    val RICH_TEXT_CONTAINER = TokenSet.create(PROPERTY_LIST, PROPERTY, PROPERTY_VALUE, PROPERTY_VALUE_TOKEN, TEXT_ROOT, COLORFUL_TEXT, PARAMETER, CONCEPT_COMMAND, CONCEPT_TEXT, TEXT_FORMAT, TEXT_FORMAT_TEXT)
