...
object ParadoxLocalisationTokenSets {
	...
	@JvmField val IDENTIFIER_TOKENS = TokenSet.create(PROPERTY_KEY_TOKEN, PROPERTY_REFERENCE_ID, SCRIPTED_VARIABLE_REFERENCE_ID, ICON_ID, COMMAND_SCOPE_ID, COMMAND_FIELD_ID)
