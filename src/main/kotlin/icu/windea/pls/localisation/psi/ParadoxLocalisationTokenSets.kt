...
object ParadoxLocalisationTokenSets {
    ...
    @JvmField val RICH_TEXT_CONTEXT_TOKENS = TokenSet.create(PROPERTY_LIST, PROPERTY, PROPERTY_VALUE, PROPERTY_VALUE_TOKEN, TEXT_ROOT, COLORFUL_TEXT, PARAMETER, ICON, COMMAND, CONCEPT_COMMAND, CONCEPT_STRING, TEXT_FORMAT, TEXT_FORMAT_STRING, STRING_VARIANT, STRING_VARIANT_STRING, TAG_SENSITIVE_TEXT, TAG_SENSITIVE_TEXT_STRING)
}
