...
object ParadoxLocalisationTokenSets {
    ...
    @JvmField val STRING_OR_QUOTE_TOKENS = TokenSet.create(TEXT_TOKEN, LEFT_QUOTE, RIGHT_QUOTE)
    @JvmField val EXTRA_TEMPLATE_TOKENS = TokenSet.create(PARAMETER, COMMAND)
