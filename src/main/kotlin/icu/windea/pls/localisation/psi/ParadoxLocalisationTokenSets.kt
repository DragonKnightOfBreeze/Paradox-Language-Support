...
object ParadoxLocalisationTokenSets {
    ...
    @JvmField val IDENTIFIER_TOKENS = TokenSet.create(PROPERTY_KEY_TOKEN, PARAMETER_TOKEN, SCRIPTED_VARIABLE_REFERENCE_TOKEN, COMMAND_TEXT_TOKEN, CONCEPT_NAME_TOKEN, ICON_TOKEN, TEXT_ICON_TOKEN, TEXT_FORMAT_TOKEN, TAG_TOKEN, CONTEXT_TAG_TOKEN)
    ...
    @JvmField val RICH_TEXT_CONTEXT_TOKENS = TokenSet.create(PROPERTY_LIST, PROPERTY, PROPERTY_VALUE, PROPERTY_VALUE_TOKEN, TEXT_ROOT, COLORFUL_TEXT, PARAMETER, ICON, COMMAND, CONCEPT_COMMAND, CONCEPT_TEXT, TEXT_FORMAT, TEXT_FORMAT_TEXT, STRING_VARIANT, STRING_VARIANT_STRING, TAG_SENSITIVE_TEXT, TAG_SENSITIVE_TEXT_STRING)
}
