...
object ParadoxLocalisationAttributesKeys {
	...
	@JvmField val ICON_KEY = createTextAttributesKey(PlsBundle.message("localisation.externalName.icon"), IDENTIFIER).apply {
		defaultAttributes.foregroundColor = Color(0x5C8AE6)
	}
	...
	@JvmField val LOCALISATION_KEY = createTextAttributesKey(PlsBundle.message("localisation.externalName.localisation"), PROPERTY_KEY_KEY).apply {
		defaultAttributes.effectType = EffectType.LINE_UNDERSCORE
		//defaultAttributes.effectColor = defaultAttributes.foregroundColor
	}
	@JvmField val SYNCED_LOCALISATION_KEY = createTextAttributesKey(PlsBundle.message("localisation.externalName.syncedLocalisation"), PROPERTY_KEY_KEY).apply {
		//defaultAttributes.effectType = EffectType.LINE_UNDERSCORE
		//defaultAttributes.effectColor = defaultAttributes.foregroundColor
	}
	...
	val COLOR_KEYS by lazy {
		...
		getInternalConfig().colorMap.mapValues { (_, color) ->
			createTextAttributesKey("${colorPrefix}_${color.id}", IDENTIFIER).apply {
				//defaultAttributes.foregroundColor = color.color
			}
