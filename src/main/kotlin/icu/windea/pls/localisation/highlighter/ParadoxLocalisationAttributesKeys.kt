...
object ParadoxLocalisationAttributesKeys {
	private val _separatorName = message("localisation.externalName.separator")
	private val _numberName = message("localisation.externalName.number")
	private val _localeName = message("localisation.externalName.locale")
	private val _propertyKeyName = message("localisation.externalName.propertyKey")
	private val _stringName = message("localisation.externalName.string")
	private val _commentName = message("localisation.externalName.comment")
	private val _markerName = message("localisation.externalName.marker")
	private val _propertyReferenceName = message("localisation.externalName.propertyReference")
	private val _parameterName = message("localisation.externalName.parameter")
	private val _iconName = message("localisation.externalName.icon")
	private val _sequentialNumberName = message("localisation.externalName.sequentialNumber")
	private val _commandScopeName = message("localisation.externalName.commandScope")
	private val _commandFieldName = message("localisation.externalName.commandField")
	private val _colorName = message("localisation.externalName.color")
	private val _validEscapeName = message("localisation.externalName.validEscape")
	private val _invalidEscapeName = message("localisation.externalName.invalidEscape")
	private val _badCharacterName = message("localisation.externalName.badCharacter")
	private val _localisationName = message("localisation.externalName.localisation")
	private val _syncedLocalisationName = message("localisation.externalName.syncedLocalisation")
