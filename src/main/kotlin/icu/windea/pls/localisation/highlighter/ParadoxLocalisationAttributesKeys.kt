...
object ParadoxLocalisationAttributesKeys {
    ...
    @JvmField val COMMAND_SYSTEM_SCOPE_KEY = createTextAttributesKey("PARADOX_SCRIPT.COMMAND_SYSTEM_SCOPE", STATIC_METHOD)
    ...
    @JvmField val COMMAND_LINK_PREFIX_KEY = createTextAttributesKey("PARADOX_LOCALISATION.COMMAND_LINK_PREFIX", KEYWORD)
    @JvmField val COMMAND_LINK_VALUE_KEY = createTextAttributesKey("PARADOX_LOCALISATION.COMMAND_LINK_VALUE", IDENTIFIER)
