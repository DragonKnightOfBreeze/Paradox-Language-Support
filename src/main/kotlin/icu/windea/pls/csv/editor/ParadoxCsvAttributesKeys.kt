...
object ParadoxCsvAttributesKeys {
    ...
    @JvmField
    val DEFINITION_REFERENCE_KEY = createTextAttributesKey("PARADOX_CSV.DEFINITION_REFERENCE_KEY", ParadoxScriptAttributesKeys.DEFINITION_REFERENCE_KEY)
    @JvmField
    val ENUM_VALUE_KEY = createTextAttributesKey("PARADOX_CSV.ENUM_VALUE_KEY", ParadoxScriptAttributesKeys.ENUM_VALUE_KEY)
    @JvmField
    val COMPLEX_ENUM_VALUE_KEY = createTextAttributesKey("PARADOX_CSV.COMPLEX_ENUM_KEY", ParadoxScriptAttributesKeys.COMPLEX_ENUM_VALUE_KEY)
}
