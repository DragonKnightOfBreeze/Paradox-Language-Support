...
object ParadoxCsvAttributesKeys {
    ...
    @JvmField val DEFINITION_REFERENCE = createTextAttributesKey("PARADOX_CSV.DEFINITION_REFERENCE_KEY", ParadoxScriptAttributesKeys.DEFINITION_REFERENCE)
    @JvmField val ENUM_VALUE = createTextAttributesKey("PARADOX_CSV.ENUM_VALUE_KEY", ParadoxScriptAttributesKeys.ENUM_VALUE)
    @JvmField val COMPLEX_ENUM_VALUE = createTextAttributesKey("PARADOX_CSV.COMPLEX_ENUM_KEY", ParadoxScriptAttributesKeys.COMPLEX_ENUM_VALUE)
    @JvmField val DYNAMIC_VALUE = createTextAttributesKey("PARADOX_CSV.DYNAMIC_VALUE", ParadoxScriptAttributesKeys.DYNAMIC_VALUE)
    @JvmField val VARIABLE = createTextAttributesKey("PARADOX_CSV.VARIABLE", ParadoxScriptAttributesKeys.VARIABLE)
}
