...
interface ParadoxScriptExpressionMatchOptimizer {
     ...
     * 优化逻辑是否依赖脚本文件中的上下文。
     */
    fun isDynamic(context: ParadoxExpressionMatchContext): Boolean = false
     ...
     */
    fun <T : CwtMemberConfig<*>> optimize(context: ParadoxExpressionMatchContext, input: List<T>): List<T>?
