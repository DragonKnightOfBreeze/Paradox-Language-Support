...
open class ParadoxLauncherDbExporter : ParadoxDbBasedModExporter() {
    override val text get() = ChronicleEpBundle.message("mod.exporter.launcher")
    ...
    override fun createFileSaverDescriptor(gameType: ParadoxGameType): FileSaverDescriptor {
        return FileSaverDescriptor(ChronicleEpBundle.message("mod.exporter.launcher"), "", "sqlite")
    }
