...
interface SpecialPathProviders {
    ...
    class GameExecutable : SpecialPathProvider {
        override val text get() = PlsBundle.message("special.path.gameExecutable")
    ...
    class GameModDirectory : SpecialPathProvider {
        override val text get() = PlsBundle.message("special.path.gameModDirectory")
    ...
    class GameSaveGames : SpecialPathProvider {
        override val text get() = PlsBundle.message("special.path.gameSaveGames")
    ...
    class GameLogs : SpecialPathProvider {
        override val text get() = PlsBundle.message("special.path.gameLogs")
