...
class ParadoxLauncherJsonV2Exporter : ParadoxJsonBasedModExporter() {
    override val text get() = ChronicleEpBundle.message("mod.exporter.launcherJson.v2")
    ...
    override fun createFileSaverDescriptor(gameType: ParadoxGameType): FileSaverDescriptor {
        return FileSaverDescriptor(ChronicleEpBundle.message("mod.exporter.launcherJson.v2.title"), "", "json")
    }
