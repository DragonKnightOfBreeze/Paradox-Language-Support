...
class ParadoxLauncherJsonV2Exporter : ParadoxJsonBasedModExporter() {
    override val text get() = PlsEpBundle.message("mod.exporter.launcherJson.v2")
    ...
    override fun createFileSaverDescriptor(gameType: ParadoxGameType): FileSaverDescriptor {
        return FileSaverDescriptor(PlsEpBundle.message("mod.exporter.launcherJson.v2.title"), "", "json")
    }
