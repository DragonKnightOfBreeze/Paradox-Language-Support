...
class ConvertDdsToPngAction : DumbAwareAction() {
	...
	@Suppress("UnstableApiUsage")
	private fun handleExistingFiles(defaultChoice: SkipOverwriteChoice?, choice: IntArray?, newName: String?,
		targetDirectory: PsiDirectory, title: String, existingFiles: MultiMap<PsiDirectory, PsiFile>,
		added: MutableList<PsiFile>, progressIndicator: ProgressIndicator?): SkipOverwriteChoice? {
