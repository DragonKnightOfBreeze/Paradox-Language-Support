...
class ParadoxDefinitionInjectionFileStructureGroupRuleProvider : FileStructureGroupRuleProvider {
    override fun getUsageGroupingRule(project: Project): UsageGroupingRule {
        return ParadoxDefinitionInjectionUsageGroupingRule()
    }
}

private class ParadoxDefinitionInjectionUsageGroupingRule : SingleParentUsageGroupingRule() {
    override fun getParentGroupFor(usage: Usage, targets: Array<out UsageTarget>): UsageGroup? {
        ...
        return ParadoxDefinitionInjectionUsageGroup(element, info.target, info.type)
    }
...
private class ParadoxDefinitionInjectionUsageGroup(
    ...
    private fun isSame(other: ParadoxDefinitionInjectionUsageGroup): Boolean {
