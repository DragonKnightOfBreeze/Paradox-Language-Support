...
class Ck2EventDataProvider : ParadoxDefinitionDataProvider<Ck2EventDataProvider.Data> {
    ...
    override val cachedDataKey = Key.create<CachedValue<Data>>("ck2.data.cached.event")
    
    override fun supports(definition: ParadoxScriptDefinitionElement, definitionInfo: ParadoxDefinitionInfo): Boolean {
        return definitionInfo.gameType == ParadoxGameType.Ck2 && definitionInfo.type == "event"
    }
