...
class Ck3EventDataProvider : ParadoxDefinitionDataProvider<Ck3EventDataProvider.Data> {
    ...
    override val cachedDataKey = Key.create<CachedValue<Data>>("ck3.data.cached.event")
    
    override fun supports(definition: ParadoxScriptDefinitionElement, definitionInfo: ParadoxDefinitionInfo): Boolean {
        return definitionInfo.gameType == ParadoxGameType.Ck3 && definitionInfo.type == "event"
    }
