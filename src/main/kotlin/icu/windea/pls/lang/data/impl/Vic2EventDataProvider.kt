...
class Vic2EventDataProvider : ParadoxDefinitionDataProvider<Vic2EventDataProvider.Data> {
    ...
    override val cachedDataKey = Key.create<CachedValue<Data>>("vic2.data.cached.event")
    
    override fun supports(definition: ParadoxScriptDefinitionElement, definitionInfo: ParadoxDefinitionInfo): Boolean {
        return definitionInfo.gameType == ParadoxGameType.Vic2 && definitionInfo.type == "event"
    }
