...
class TooManyExpressionInspection : LocalInspectionTool() {
    ...
    override fun getOptionsPane(): OptPane {
        return OptPane.pane(
            OptPane.checkbox("firstOnly", ChronicleInspectionBundle.message("inspection.tooManyExpression.option.firstOnly")),
            OptPane.checkbox("firstOnlyOnFile", ChronicleInspectionBundle.message("inspection.tooManyExpression.option.firstOnlyOnFile")),
