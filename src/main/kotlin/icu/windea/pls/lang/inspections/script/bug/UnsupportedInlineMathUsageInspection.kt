...
class UnsupportedInlineMathUsageInspection: LocalInspectionTool() {
    ...
    //        }
    //        
    //        doBuildVisitor("scripted_trigger", PlsBundle.message("inspection.script.unsupportedInlineMathUsage.desc.2"))
    //            ?.let { return it }
    //        doBuildVisitor("scripted_effect", PlsBundle.message("inspection.script.unsupportedInlineMathUsage.desc.3"))
    //            ?.let { return it }
    //    }
    //}
}
