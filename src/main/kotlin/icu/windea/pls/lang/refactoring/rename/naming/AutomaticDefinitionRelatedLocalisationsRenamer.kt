...
class AutomaticDefinitionRelatedLocalisationsRenamer(element: PsiElement, newName: String) : AutomaticRenamer() {
    ...
    override fun getDialogTitle() = ChronicleBundle.message("rename.definition.relatedLocalisations.title")

    override fun getDialogDescription() = ChronicleBundle.message("rename.definition.relatedLocalisations.desc")

    override fun entityName() = ChronicleBundle.message("rename.definition.relatedLocalisations.entityName")
