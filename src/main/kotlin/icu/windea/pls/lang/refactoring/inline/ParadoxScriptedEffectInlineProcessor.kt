...
class ParadoxScriptedEffectInlineProcessor(
    ...
    override fun getCommandName() = ChronicleBundle.message("inline.scriptedEffect.command", descriptiveName)
    ...
    override fun getRefactoringId(): String {
        return "chronicle.refactoring.inline.scriptedEffect"
    }
    ...
    private fun doRefactoring(usages: Array<out UsageInfo>) {
        for (usage in usages) {
            ...
            try {
                ParadoxPsiService.inlineScriptedEffect(usageElement, rangeInUsageElement, element, myProject)
