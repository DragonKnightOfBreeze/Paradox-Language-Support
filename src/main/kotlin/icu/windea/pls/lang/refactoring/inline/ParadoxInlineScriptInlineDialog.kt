...
class ParadoxInlineScriptInlineDialog(
    ...
    init {
        title = ChronicleBundle.message("title.inline.inlineScript")
    ...
    override fun getInlineThisText(): String {
        return ChronicleBundle.message("inline.inlineScript.inline.this")
    }

    override fun getInlineAllText(): String {
        return if (element.isWritable) ChronicleBundle.message("inline.inlineScript.inline.all.remove")
        else ChronicleBundle.message("inline.inlineScript.inline.all")
    }

    override fun getKeepTheDeclarationText(): String {
        return if (element.isWritable) ChronicleBundle.message("inline.inlineScript.inline.all.keep")
