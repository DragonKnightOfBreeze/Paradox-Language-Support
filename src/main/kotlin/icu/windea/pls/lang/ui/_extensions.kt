...
fun Row.localeComboBox(configGroup: CwtConfigGroup = PlsFacade.getConfigGroup(), includeAuto: Boolean = false, includeDefault: Boolean = false, pingPreferred: Boolean = true): Cell<ComboBox<String>> {
