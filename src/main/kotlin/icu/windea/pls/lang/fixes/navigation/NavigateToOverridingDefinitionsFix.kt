...
class NavigateToOverridingDefinitionsFix(
    ...
    override fun getFamilyName() = ChronicleInspectionBundle.message("fix.navigateTo.overridingDefinitions.name")

    override fun getPopupTitle(editor: Editor) = ChronicleInspectionBundle.message("fix.navigateTo.overridingDefinitions.popup.title", key)
