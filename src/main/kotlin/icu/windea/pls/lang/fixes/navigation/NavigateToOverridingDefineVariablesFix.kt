...
class NavigateToOverridingDefineVariablesFix(
    private val key: String,
    target: PsiElement,
    elements: Collection<PsiElement>
) : NavigateToFix(target, elements) {
    override fun getFamilyName() = ChronicleInspectionBundle.message("fix.navigateTo.overridingDefineVariables.name")

    override fun getPopupTitle(editor: Editor) = ChronicleInspectionBundle.message("fix.navigateTo.overridingDefineVariables.popup.title", key)
