...
class NavigateToRecursionsFix(
    ...
    override fun getFamilyName() = ChronicleInspectionBundle.message("fix.navigateTo.recursions.name")

    override fun getPopupTitle(editor: Editor) = ChronicleInspectionBundle.message("fix.navigateTo.recursions.popup.title", key)
