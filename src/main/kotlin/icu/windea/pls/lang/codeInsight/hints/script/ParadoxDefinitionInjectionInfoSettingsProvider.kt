...
class ParadoxDefinitionInjectionInfoSettingsProvider : InlayHintsCustomSettingsProvider<Settings> {
    ...
    override fun createComponent(project: Project, language: Language): JComponent {
        ...
        showSubtypes = s.showSubtypesForDefinitionInjection
        truncateSubtypes = s.truncateSubtypesForDefinitionInjection
        return component
    }
    ...
    override fun persistSettings(project: Project, settings: Settings, language: Language) {
        val s = getSettingsInstance(project)
        s.showSubtypesForDefinitionInjection = settings.showSubtypes
        s.truncateSubtypesForDefinitionInjection = settings.truncateSubtypes
    }
