 ...
 */
class ParadoxDefinitionInjectionInfoSettingsProvider : InlayHintsCustomSettingsProvider<Settings> {
    data class Settings(
    ...
    override fun createComponent(project: Project, language: Language): JComponent {
        ...
        showSubtypes = s.showDefinitionSubtypesForInjections
        truncateSubtypes = s.truncateDefinitionSubtypesForInjections
        return component
    }
    ...
    override fun persistSettings(project: Project, settings: Settings, language: Language) {
        val s = ParadoxDeclarativeHintsSettings.getInstance(project)
        s.showDefinitionSubtypesForInjections = settings.showSubtypes
        s.truncateDefinitionSubtypesForInjections = settings.truncateSubtypes
    }
}
