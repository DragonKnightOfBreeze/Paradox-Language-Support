...
class ParadoxDefinitionRelatedInjectionsLineMarkerProvider : ParadoxRelatedItemLineMarkerProvider() {
    ...
    override fun collectNavigationMarkers(element: PsiElement, result: MutableCollection<in RelatedItemLineMarkerInfo<*>>) {
        ...
        val targets = ParadoxDefinitionInjectionSearch.searchElement(null, definitionInfo.name, definitionInfo.type, selector).findAll().optimized()
        ...
        NavigateAction.setNavigateAction(lineMarkerInfo, actionText, ChronicleActions.GotoRelatedDefinitionInjections)
    }
}
