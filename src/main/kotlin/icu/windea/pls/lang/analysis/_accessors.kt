...
inline var useDefaultFileExtensions: Boolean // region
...
context(_: ParadoxAnalysisScope)
inline var useGameTypeInference: Boolean // region
...
context(_: ParadoxAnalysisScope)
inline var markedRootInfo: ParadoxRootInfo? // region
...
context(_: ParadoxAnalysisScope)
inline var markedFileInfo: ParadoxFileInfo? // region
...
context(_: ParadoxAnalysisScope)
inline var markedRootPath: String? // region
...
context(_: ParadoxAnalysisScope)
inline var markedRootDirectory: Path? // region
...
context(_: ParadoxAnalysisScope)
inline var markedConfigPath: String? // region
...
context(_: ParadoxAnalysisScope)
inline var markedConfigDirectory: Path? // region
...
context(_: ParadoxAnalysisScope)
inline var useOnlyBuiltInAndInjectedConfigFiles: Boolean  // region
...
context(_: ParadoxAnalysisScope)
inline var useOnlyInjectedConfigFiles: Boolean // region
...
context(_: ParadoxAnalysisScope)
inline var VirtualFile.cachedRootInfo: LazyValue<ParadoxRootInfo>? // region
...
context(_: ParadoxAnalysisScope)
inline var VirtualFile.cachedFileInfo: LazyValue<ParadoxFileInfo>? // region
...
context(_: ParadoxAnalysisScope)
inline var VirtualFile.cachedLocaleConfig: LazyValue<CwtLocaleConfig>? // region
...
context(_: ParadoxAnalysisScope)
inline var VirtualFile.injectedRootInfo: ParadoxRootInfo? // region
...
context(_: ParadoxAnalysisScope)
inline var VirtualFile.injectedFileInfo: ParadoxFileInfo? // region
...
context(_: ParadoxAnalysisScope)
inline var VirtualFile.injectedLocaleConfig: CwtLocaleConfig? // region
...
context(_: ParadoxAnalysisScope)
inline var VirtualFile.injectedRootKeys: List<String>? // region
...
context(_: ParadoxAnalysisScope)
inline var VirtualFile.sliceInfos: MutableSet<String>? // region
