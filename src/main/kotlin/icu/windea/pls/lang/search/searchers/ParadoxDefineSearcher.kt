 ...
 * 定值的命名空间与变量的查询器。
 */
class ParadoxDefineSearcher : QueryExecutorBase<ParadoxScriptProperty, ParadoxDefineSearch.Parameters>() {
    override fun processQuery(queryParameters: ParadoxDefineSearch.Parameters, consumer: Processor<in ParadoxScriptProperty>) {
