...
class ReplaceLocalisationWithTranslationFromLocaleIntention : ManipulateLocalisationIntentionBase.WithLocalePopup() {
    override fun getFamilyName() = ChronicleIntentionBundle.message("intention.replaceLocalisationWithTranslationFromLocale")
    ...
    override suspend fun doHandle(project: Project, file: PsiFile, context: Context) {
        ...
        withBackgroundProgress(project, ChronicleIntentionBundle.message("intention.replaceLocalisationWithTranslationFromLocale.progress.title", selectedLocale.text)) action@{
    ...
    private fun createNotification(selectedLocale: CwtLocaleConfig, error: Throwable?): Notification {
        if (error == null) {
            val content = ChronicleIntentionBundle.message("intention.replaceLocalisationWithTranslationFromLocale.notification", selectedLocale.text, Messages.success())
        ...
        val content = ChronicleIntentionBundle.message("intention.replaceLocalisationWithTranslationFromLocale.notification", selectedLocale.text, Messages.failed()) + errorDetails
