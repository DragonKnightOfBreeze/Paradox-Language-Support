 ...
 * @see icu.windea.pls.lang.search.usage.ParadoxDefinitionUsagesSearcher
 */
class DefinitionNameFindUsagesIntention : DefinitionNameIntention() {
	override fun getText() = PlsBundle.message("intention.definitionName.findUsages")
 ...
 * @see icu.windea.pls.lang.search.implementation.ParadoxDefinitionImplementationsSearch
 */
 ...
 * @see icu.windea.pls.lang.codeInsight.ParadoxTypeDeclarationProvider
 */
class DefinitionNameGotoTypeDeclarationIntention : DefinitionNameIntention() {
	override fun getText() = PlsBundle.message("intention.definitionName.gotoTypeDeclaration")
	...
	override fun doInvoke(definition: ParadoxScriptDefinitionElement, definitionInfo: ParadoxDefinitionInfo, editor: Editor, project: Project) {
		...
		getPsiElementPopup(result.toTypedArray(),  PlsBundle.message("intention.definitionName.gotoTypeDeclaration.title", definitionInfo.name))
			.showInBestPositionFor(editor)
	}
}
