...
class ChangeLocalisationColorIntention : ModCommandAction {
    override fun getFamilyName() = ChronicleIntentionBundle.message("intention.changeLocalisationColor")
    ...
    override fun perform(context: ActionContext): ModCommand {
        ...
        return ModCommand.chooseAction(ChronicleIntentionBundle.message("intention.changeLocalisationColor.title"), items)
    }
    ...
    private class ItemIntention(
        ...
        override fun getFamilyName() = ChronicleIntentionBundle.message("intention.changeLocalisationColor.item", colorConfig.name)
