 ...
 */
class CopyLocalisationListWithLocaleIntention : PsiBasedModCommandAction<ParadoxLocalisationLocale>(ParadoxLocalisationLocale::class.java), DumbAware {
    ...
    override fun perform(context: ActionContext, element: ParadoxLocalisationLocale): ModCommand {
        ...
        val text = localisationList.text.trim() // 去除首尾空白
