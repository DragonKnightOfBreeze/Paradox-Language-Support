 ...
 */
class ParadoxLocalisationTextPlainRenderer : ParadoxLocalisationTextRenderer<String, ParadoxLocalisationTextPlainRenderContext, ParadoxLocalisationTextRenderSettings>() {
    override val settings = ParadoxLocalisationTextPlainRenderSettings

    override fun createContext() = ParadoxLocalisationTextPlainRenderContext(settings)
}
...
data object ParadoxLocalisationTextPlainRenderSettings : ParadoxLocalisationTextRenderSettings()
