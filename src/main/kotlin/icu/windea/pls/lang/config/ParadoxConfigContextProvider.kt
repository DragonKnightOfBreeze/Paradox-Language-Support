...
interface ParadoxConfigContextProvider {
    fun getConfigContext(element: ParadoxScriptMemberElement, file: PsiFile): ParadoxConfigContext?
    ...
    companion object INSTANCE {
        ...
        fun getContext(element: ParadoxScriptMemberElement, file: PsiFile): ParadoxConfigContext? {
            return EP_NAME.extensionList.firstNotNullOfOrNull f@{ ep ->
                ep.getConfigContext(element, file)
                    ?.also { it.provider = ep }
            }
        }
    }
