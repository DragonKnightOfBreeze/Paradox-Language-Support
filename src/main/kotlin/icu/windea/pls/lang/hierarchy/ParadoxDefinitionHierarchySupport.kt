...
interface ParadoxDefinitionHierarchySupport {
    ...
    fun indexData(fileData: MutableMap<String, List<ContextInfo>>, element: ParadoxScriptStringExpressionElement, config: CwtMemberConfig<*>, definitionInfo: ParadoxDefinitionInfo)
    
    fun saveData(storage: DataOutput, data: ContextInfo)
    
    fun readData(storage: DataInput, data: ContextInfo)
