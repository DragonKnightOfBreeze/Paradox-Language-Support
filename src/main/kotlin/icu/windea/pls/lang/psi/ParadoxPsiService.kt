...
object ParadoxPsiService {
    ...
    fun inlineScriptedTrigger(element: PsiElement, rangeInElement: TextRange, declaration: ParadoxScriptProperty, project: Project) {
        ...
        if (reverse) {
            ...
            val start = ParadoxScriptPsiService.findStartElementToExtract(newRef)
            val end = ParadoxScriptPsiService.findEndElementToExtract(newRef)
    ...
    fun inlineLocalisation(element: PsiElement, rangeInElement: TextRange, declaration: ParadoxLocalisationProperty, project: Project) {
        ...
        val start = ParadoxLocalisationPsiService.findStartElementToExtract(newRef)
        val end = ParadoxLocalisationPsiService.findEndElementToExtract(newRef)
        if (start != null && end != null) {
