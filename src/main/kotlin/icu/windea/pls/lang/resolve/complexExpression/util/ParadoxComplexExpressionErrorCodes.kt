...
object ParadoxComplexExpressionErrorCodes {
    ...
    const val UNRESOLVED_STELLARIS_NAME_PARTS_LIST = 9
    const val UNRESOLVED_STELLARIS_NAME_FORMAT_LOCALISATION = 10
    ...
    const val MALFORMED_STELLARIS_NAME_FORMAT_EXPRESSION = 108
