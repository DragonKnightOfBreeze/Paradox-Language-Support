...
value class ParadoxComplexExpressionAttributes(private val value: Int) {
    ...
    val lenientDynamicDataInvolved: Boolean get() = BitUtil.isSet(value, Flags.LENIENT_DYNAMIC_DATA_INVOLVED)

    override fun toString(): String {
        return "ParadoxComplexExpressionAttributes(" +
            "dynamicDataInvolved=$dynamicDataInvolved" +
            ", lenientDynamicDataInvolved=$lenientDynamicDataInvolved" +
            ")"
    }

    object Flags {
        const val DYNAMIC_DATA_INVOLVED = 0x1
        const val LENIENT_DYNAMIC_DATA_INVOLVED = 0x2
    }
}
