 ...
 * @property involvesInferredScopeContextAwareDefinitionReference 规则树中是否涉及可能匹配可推断作用域上下文的定义引用的数据表达式。参见 [CwtDefinitionTypesModel.supportScopeContextInference]。
