...
open class CwtConfigGroupDataModelBase : CwtConfigGroupDataModel {
    ...
    final override val modifierCategories: Object2ObjectLinkedOpenCustomHashMap<@CaseInsensitive String, CwtModifierCategoryConfig> = CaseInsensitiveStringKeyMap()
