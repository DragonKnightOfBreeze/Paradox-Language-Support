 ...
 */
class CwtTypeConfig private constructor(
    ...
    companion object {
        fun resolve(config: CwtPropertyConfig, name: String): CwtTypeConfig {
            ...
            if(!props.isNullOrEmpty()) {
                for(prop in props) {
                    ...
                    if(subtypeName != null) {
                        val subtypeConfig = CwtSubtypeConfig.resolve(prop, subtypeName)
            ...
            return CwtTypeConfig(
                ...
                baseType, path, pathStrict, pathFile, pathExtension,
                nameField, nameFromFile, typePerFile, unique, severity, skipRootKey,
                typeKeyFilter, typeKeyRegex, startsWith, graphRelatedTypes, subtypes,
                localisation, images
            )
        }
    }
