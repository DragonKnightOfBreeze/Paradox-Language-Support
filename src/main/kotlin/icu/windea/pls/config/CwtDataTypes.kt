...
object CwtDataTypes {
     ...
     *
     * 匹配花括号块（`{ ... }`）。要求值位置且表达式类型为 Block，并递归匹配子句内容。
     */
