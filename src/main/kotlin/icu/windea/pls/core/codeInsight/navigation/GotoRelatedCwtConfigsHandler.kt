...
class GotoRelatedCwtConfigsHandler : GotoTargetHandler() {
    ...
    override fun getSourceAndTargetElements(editor: Editor, file: PsiFile): GotoData? {
        ...
        val configs = ParadoxConfigHandler.getConfigs(location, isKey, Options.Default or Options.AcceptDefinition)
                ...
                if(location is ParadoxScriptStringExpressionElement) {
                    ...
                    when {
                        ...
                        configExpression.type == CwtDataType.Modifier -> {
                            val modifierElement = ParadoxModifierHandler.resolveModifier(location, name, configGroup)
