...
object ParadoxValueSetValueFastIndex {
    ...
    val executorService by lazy { AppExecutorUtil.createBoundedApplicationPoolExecutor("ParadoxValueSetValueFastIndex Pool", 4) }
            ...
            psiFile.acceptChildren(object : PsiRecursiveElementWalkingVisitor() { //perf: 95%
                override fun visitElement(element: PsiElement) {
                    if(element is ParadoxScriptStringExpressionElement && element.isExpression()) {
                        ...
                        data.valueSetValueInfoList.addInfos(infos, keys)
                    }
    ...
    private fun MutableList<ParadoxValueSetValueInfo>.addInfos(infos: List<ParadoxValueSetValueInfo>, keys: MutableSet<String>) {
