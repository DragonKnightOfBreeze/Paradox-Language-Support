...
fun <E : Any> OptimizerFactory.forList(): Optimizer.Unary<List<E>> = getTyped(ListOptimizer)
fun <E : Any> OptimizerFactory.forSet(): Optimizer.Unary<Set<E>> = getTyped(SetOptimizer)
fun <K : Any, V : Any> OptimizerFactory.forMap(): Optimizer.Unary<Map<K, V>> = getTyped(MapOptimizer)
