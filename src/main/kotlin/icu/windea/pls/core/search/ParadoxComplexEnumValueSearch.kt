...
class ParadoxComplexEnumValueSearch : ExtensibleQueryFactory<ParadoxComplexEnumValueInfo, ParadoxComplexEnumValueSearch.SearchParameters>(EP_NAME) {
	...
	companion object {
        @JvmField val EP_NAME = ExtensionPointName.create<QueryExecutor<ParadoxComplexEnumValueInfo, SearchParameters>>("icu.windea.pls.search.complexEnumValueSearch")
