...
class ParadoxComplexEnumValueReferencesSearcher: QueryExecutorBase<PsiReference, ReferencesSearch.SearchParameters>(true) {
	...
	private fun doPrecessQuery(target: ParadoxExpressionAwareElement, optimizer: SearchRequestCollector) {
		val complexEnumValueInfo = target.complexEnumValueInfo ?: return
		optimizer.searchWord(complexEnumValueInfo.name, target.useScope, true, target)
	}
}
