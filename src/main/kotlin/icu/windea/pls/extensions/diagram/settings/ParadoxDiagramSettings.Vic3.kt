...
@ForGameType(ParadoxGameType.Vic3)
@Service(Service.Level.PROJECT)
@State(name = "ParadoxDiagramSettings.Vic3.EventTree", storages = [Storage(ChronicleConstants.pluginSettingsFileName)])
class Vic3EventTreeDiagramSettings(
    ...
    companion object {
        const val ID = "chronicle.diagram.Vic3.EventTree"
    }
    ...
    override val groupName: String = ChronicleDiagramBundle.message("eventTree.name.vic3")
