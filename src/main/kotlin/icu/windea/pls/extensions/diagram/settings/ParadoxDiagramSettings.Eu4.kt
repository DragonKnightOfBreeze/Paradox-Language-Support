...
@ForGameType(ParadoxGameType.Eu4)
@Service(Service.Level.PROJECT)
@State(name = "ParadoxDiagramSettings.Eu4.EventTree", storages = [Storage(ChronicleConstants.pluginSettingsFileName)])
class Eu4EventTreeDiagramSettings(
    ...
    companion object {
        const val ID = "chronicle.diagram.Eu4.EventTree"
    }
    ...
    override val groupName: String = ChronicleDiagramBundle.message("eventTree.name.eu4")
