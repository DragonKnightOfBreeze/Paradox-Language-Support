...
class CwtModifierCategoriesConfigGenerator(override val project: Project) : CwtConfigGenerator {
    ...
    override fun getName() = "ModifierCategoriesConfigGenerator"

    override fun getDefaultInputName() = "modifiers.log"

    override fun getDefaultOutputName() = "modifier_categories.cwt"

    override suspend fun generate(gameType: ParadoxGameType, inputPath: String, outputPath: String): CwtConfigGenerator.Hint {
        // 解析日志：聚合所有出现过的类别
    ...
    private suspend fun generateHint(outputPath: String, categoriesFromLog: Set<String>, categoriesInConfig: Set<String>): CwtConfigGenerator.Hint {
