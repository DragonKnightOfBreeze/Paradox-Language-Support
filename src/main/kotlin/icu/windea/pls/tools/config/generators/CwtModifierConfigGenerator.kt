...
class CwtModifierConfigGenerator(override val project: Project) : CwtConfigGenerator {
    ...
    private suspend fun generateHint(outputPath: String, infos: Map<String, ModifierInfo>, configInfo: ModifierConfigInfo, gameType: ParadoxGameType): CwtConfigGenerator.Hint {
