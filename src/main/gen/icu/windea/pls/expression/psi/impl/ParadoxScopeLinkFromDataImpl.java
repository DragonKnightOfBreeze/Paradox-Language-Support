...
public class ParadoxScopeLinkFromDataImpl extends ParadoxScopeFieldImpl implements ParadoxScopeLinkFromData {

  public ParadoxScopeLinkFromDataImpl(@NotNull ASTNode node) {
    super(node);
  }
