...
public interface ParadoxScriptElementTypes {
  ...
  IElementType INLINE_MATH_BINARY_EXPRESSION = ParadoxScriptElementTypeFactory.getElementType("INLINE_MATH_BINARY_EXPRESSION");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == INLINE_MATH_BINARY_EXPRESSION) {
        return new ParadoxScriptInlineMathBinaryExpressionImpl(node);
      }
      else if (type == INLINE_MATH_GROUPING_EXPRESSION) {
        return new ParadoxScriptInlineMathGroupingExpressionImpl(node);
      }
