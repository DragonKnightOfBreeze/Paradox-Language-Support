...
- **注意事项**
  ...
  - 若在 IDE 中直接运行测试，需确保转交给 Gradle 或手动添加 VM Options。
- **参考链接**
  - Gradle Test 任务与系统属性（systemProperty）：
    - https://docs.gradle.org/current/dsl/org.gradle.api.tasks.testing.Test.html#org.gradle.api.tasks.testing.Test:systemProperty
  - Gradle 测试执行与 JVM 配置：
