...
- [x] P2 重构 `CwtConfigContext` 和 `CwtDeclarationConfigContext`：更改获取方式和创建方式，优化性能和内存占用
- [ ] P2 分析与优化构建索引时的性能和内存占用
...
- [x] P3 重构代码补全系统：新增 `ParadoxCompletionLookupProvider` 和 `CwtCompletionLookupProvider`
