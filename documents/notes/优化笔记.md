...
---icu.windea.pls.lang.match.ParadoxMatchResultProvider.getDefinitionMatchResult$lambda$8(Set, String, Project, PsiElement, String) - 69.058s
---icu.windea.pls.lang.match.ParadoxMatchResultProvider.getComplexEnumValueMatchResult$lambda$18(Project, PsiElement, String, String) - 44.751
---icu.windea.pls.lang.match.ParadoxMatchResultProvider.getLocalisationMatchResult$lambda$12(Set, String, Project, PsiElement) - 24.772s
...
一旦打开了过大的脚本文件，能够明显感觉到性能问题，即使关闭此脚本文件，问题仍然存在。

似乎阈值在1.2万行左右，在阈值之内一切良好，但如果打开一个2万行的脚本文件，能够明显感觉到变化：
