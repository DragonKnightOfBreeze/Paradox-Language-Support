...
-----icu.windea.pls.lang.util.ParadoxExpressionManager.getConfigContext(PsiElement) - 16.773s, 17.1% - 耗时来自解析 elementPath，以及获取定义信息
...
--icu.windea.pls.ep.configContext.CwtBaseConfigContextProvider.getContext(ParadoxScriptMember, ParadoxElementPath, PsiFile) - 5.618s, 39.3% #
...
---icu.windea.pls.model.paths.ParadoxElementPathKt.relativeTo(ParadoxElementPath, ParadoxElementPath) - 1.978s, 13.8% - 耗时来自解析 elementPath
--icu.windea.pls.ep.configContext.CwtInlineScriptConfigContextProvider.getContext(ParadoxScriptMember, ParadoxElementPath, PsiFile) - 1.482s, 10.4%
-icu.windea.pls.lang.util.ParadoxScriptFileManager.getElementPath$default(ParadoxScriptFileManager, PsiElement, int, int, Object) - 4.213s, 29.5%
...
--icu.windea.pls.lang.util.ParadoxExpressionManager.getConfigsForConfigContext(ParadoxScriptMember, List, ParadoxElementPath, CwtConfigGroup, int)
...
icu.windea.pls.lang.util.ParadoxExpressionManager.getConfigsForConfigContext(ParadoxScriptMember, List, ParadoxElementPath, CwtConfigGroup, int) - 25.871s
-icu.windea.pls.lang.util.ParadoxExpressionManager.doGetConfigsForConfigContext(ParadoxScriptMember, List, ParadoxElementPath, CwtConfigGroup, int) - 24.519s, 94.8%
...
- 在创建时不要 intern elementPath ✔
- 考虑仅在需要加入缓存时才 intern elementPath ✔
...
---icu.windea.pls.lang.util.ParadoxExpressionManager.doGetConfigsForConfigContext(ParadoxScriptMember, List, ParadoxElementPath, CwtConfigGroup, int) - 11.830s, ~16.8%
...
| icu.windea.pls.model.paths.impl.ParadoxElementPathImpl       | 220,372 | 5.29 MB   | 53.68 MB  |
...
- 优化 `ParadoxElementPath`（以及其他路径模型） - 考虑适用 intern ✔ + 考虑适用有上限的缓存
...
--icu.windea.pls.lang.util.ParadoxExpressionManager.getConfigContext(PsiElement) - 6.047s, 5.6% - 耗时来自查找父定义、获取 elementPath
...
icu.windea.pls.lang.util.ParadoxScriptFileManager.getElementPath(PsiElement, int) - 2.176s
icu.windea.pls.model.paths.impl.ParadoxElementPathImpl.<init>(List) - 1.264s
...
| icu.windea.pls.model.paths.impl.ParadoxElementPathImpl                    | 217,903 | 5.23 MB   | 21.1 MB  |
...
- 考虑仅在需要加入缓存时才 intern elementPath 和 filePath（使用自定义的 `optimized()`） ✔
...
-icu.windea.pls.model.paths.impl.NormalizedParadoxElementPath 582,198 instances - 多多级路径的缓存可能是不必要的？
...
-<java.util.concurrent.ConcurrentHashMap 0x8ac25b90 69.41 MB
 ...
 cache of icu.windea.pls.model.paths.impl.ParadoxElementPathResolverImplKt 0x8ac25120 183.4 MB
-<java.util.concurrent.ConcurrentHashMap 0x8ac26158 53.49 MB
 ...
 interner of icu.windea.pls.model.paths.impl.ParadoxElementPathResolverImplKt 0x8ac25120 183.4 MB
...
icu.windea.pls.config.configContext.CwtConfigContext 94,672 instances - 3.79 MB, 12.18 MB - 主要来自 userData，比如 definitionInfo 和 elementPath
...
icu.windea.pls.model.paths.impl.NormalizedParadoxElementPath 610,721 instances - 14.66 MB, 49.15 MB
...
icu.windea.pls.model.paths.impl.NormalizedParadoxElementPath 289,838 instances - 6.96 MB, 19.76 MB
